...
wiced_result_t configure_device()
{
    ...
    if ( WICED_SUCCESS != wiced_dct_read_lock( (void**) &device_configured, WICED_FALSE, DCT_WIFI_CONFIG_SECTION, OFFSETOF(smart_home_app_dct_t, device_configured), sizeof(wiced_bool_t) ) )
    {
        return WICED_ERROR;
    }
